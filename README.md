...
- [Overview](#overview)
- [Forecast Release](#forecast-release)
- [Main Results](#main-results)
  - [National Forecast](#national-forecast)
  - [Municipality-Level Forecasts](#municipality-level-forecasts)
- [Forecast Maps](#forecast-maps)
  - [Predicted Electoral Presence](#predicted-electoral-presence)
  - [Predicted Vote Shares](#predicted-vote-shares)
  - [Forecast Uncertainty](#forecast-uncertainty)
- [Methodology](#methodology)
- [Data](#data)
  - [Historical Elections](#historical-elections)
  - [Forecast Inputs](#forecast-inputs)
- [Repository Structure](#repository-structure)
- [Reproducibility](#reproducibility)
- [Election Evaluation](#election-evaluation)
...
This repository contains forecasts for the **2026 Swedish municipal
elections** generated before election day using a bounded neural
zero-inflated negative binomial (ZINB) forecasting model.

The repository serves two purposes:

1.  To provide a publicly archived forecast record prior to the
    election.
2.  To evaluate forecast accuracy after the official election results
    become available.

The forecasts were generated using historical municipal-election data,
candidate-list information, and municipality-level voter composition
data obtained from the Swedish Election Authority.
...
No information from the final 2026 election results was used in model
development, estimation, tuning, or forecasting.
...
The maps display the predicted probability that a party belongs to the
count-generating process rather than the structural-zero state.
...
![](figures/forecast_map_var_mu.png) maps display the logarithmic
variance-to-mean ratio implied by the fitted negative-binomial model.

------------------------------------------------------------------------

# Methodology

The forecasting framework is a bounded neural zero-inflated negative
binomial model designed for local multiparty elections.
...
where (N_i) is the number of eligible voters and (()) is the sigmoid
function.

This guarantees that expected votes for a party cannot exceed the size
...
At the time of forecast generation, detailed 2026 electorate-composition
statistics were not yet available. Municipality-level electorate
characteristics were therefore carried forward from the corresponding
2022 measurements.
...
After official election results become available, this repository will
be updated with:
...
This project demonstrates how modern machine-learning methods can be
integrated with probabilistic count-data models to forecast multiparty
local elections.
